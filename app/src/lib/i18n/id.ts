...
const messages: TranslationMap = {
  ...
  'welcome.title': 'Selamat datang di Marvi',
  ...
  'welcome.resetErrorFallback':
    'Tidak dapat menghapus data aplikasi. Silakan keluar dan buka kembali Marvi, lalu coba lagi.',
  ...
  'home.statusCoreUnreachable':
    'Core sidecar lokal tidak merespons. Proses latar Marvi mungkin crash atau gagal dimulai.',
  ...
  'rewards.localUnavailable':
    'Login lokal tidak mendapatkan reward, kupon, atau kredit referral. Keluar lalu lanjutkan dengan masuk menggunakan akun Marvi jika Anda ingin reward dihitung.',
  ...
  'onboarding.welcome': 'Hai. Saya Marvi.',
  ...
  'onboarding.finishDesc': 'Semua siap! Mulai gunakan Marvi.',
  'onboarding.skip': 'Lewati',
  'onboarding.getStarted': 'Mulai',
  'onboarding.runtimeChoice.title': 'Bagaimana Anda ingin menjalankan Marvi?',
  ...
  'onboarding.runtimeChoice.cloud.tagline': 'Biarkan Marvi mengelola segalanya untuk Anda.',
  ...
  'onboarding.custom.defaultSubtitle': 'Biarkan Marvi mengelolanya untuk Anda.',
  ...
  'onboarding.custom.inference.defaultDesc':
    'Marvi mengarahkan setiap beban kerja ke model default yang masuk akal. Tidak perlu key, tidak perlu pengaturan.',
  ...
  'onboarding.custom.voice.defaultDesc':
    'Marvi dilengkapi dengan STT/TTS terkelola yang langsung berfungsi. Tidak ada yang perlu dikonfigurasi.',
  ...
  'onboarding.custom.oauth.defaultDesc':
    'Marvi menjalankan workspace Composio terkelola. Satu klik untuk menghubungkan setiap layanan nanti.',
  ...
  'onboarding.custom.search.subtitle': 'Cara Marvi mencari web atas nama Anda.',
  'onboarding.custom.search.defaultDesc':
    'Marvi menggunakan backend pencarian terkelola. Tidak perlu key.',
  'onboarding.custom.search.configureDesc':
    'Bawa key penyedia pencarian Anda sendiri (Tavily, Brave, dll.). Konfigurasi di Pengaturan › Alat.',
  'onboarding.custom.embeddings.title': 'Embeddings',
  'onboarding.custom.embeddings.subtitle':
    'Cara Marvi menghasilkan embedding vektor untuk pencarian memori semantik.',
  'onboarding.custom.embeddings.defaultDesc':
    'Marvi menggunakan layanan embedding terkelola. Tidak perlu API key.',
  ...
  'onboarding.custom.memory.subtitle':
    'Cara Marvi mengingat konteks, preferensi, dan percakapan sebelumnya.',
  'onboarding.custom.memory.defaultDesc':
    'Marvi mengelola penyimpanan dan pengambilan memori secara otomatis. Tidak ada yang perlu diatur.',
  ...
  'privacy.shareAnonymizedDataDesc':
    'Bantu meningkatkan Marvi dengan membagikan laporan crash dan peristiwa penggunaan yang dibatasi privasi, termasuk ID akun stabil dan metadata versi aplikasi. Pesan, kunci dompet, kunci API, dan token sesi tidak pernah dikumpulkan.',
  ...
  'privacy.autoHandoffMeetDesc':
    'Saat panggilan Google Meet berakhir, orchestrator Marvi dapat membaca transkrip dan mengambil tindakan seperti menyusun pesan, menjadwalkan tindak lanjut, atau memposting ringkasan ke workspace Slack yang terhubung. Nonaktif secara default.',
  ...
  'settings.search.menuDesc':
    'Baku bagi Marvi- mengatur pencarian atau menghubungkan penyedia anda sendiri dengan kunci API.',
  'settings.search.description':
    'Pilih mesin pencari yang digunakan agen, atau nonaktifkan alat pencarian sepenuhnya. Managed menggunakan backend Marvi (tanpa pengaturan). Parallel, Brave, dan Querit berjalan langsung dari mesin Anda menggunakan kunci API Anda.',
  ...
  'settings.search.engineManagedLabel': 'Marvi Dikelola',
  'settings.search.engineManagedDesc':
    'Baku. Diarahkan melalui backend Marvi — tidak diperlukan kunci API.',
  'settings.search.localManagedUnavailable':
    'Pencarian Marvi Managed tidak tersedia untuk pengguna lokal. Tambahkan API key Parallel atau Brave Anda sendiri untuk mengaktifkan pencarian web.',
  ...
  'devices.betaText':
    'Fitur ini sedang dalam versi beta. Pasangkan ponsel iOS dengan Marvi ini untuk menggunakannya sebagai klien jarak jauh.',
  ...
  'devices.emptyState': 'Pindai kode QR di iPhone Anda untuk menghubungkannya ke sesi Marvi ini.',
  ...
  'devices.pairModal.instructions': 'Buka aplikasi Marvi di iPhone Anda dan pindai kode ini.',
  ...
  'mcp.connectAuth.oauthHint':
    'Server ini menggunakan OAuth. Masuk melalui browser Anda untuk mengizinkan Marvi.',
  ...
  'autonomy.maxActionsHelp':
    'Jumlah maksimum tindakan alat yang dapat dijalankan agen per jam bergulir. Nilai baru berlaku untuk obrolan berikutnya. Pekerjaan cron dan pendengar saluran tetap menggunakan batas saat ini sampai Anda me-restart Marvi.',
  ...
  'settings.tools.chooseCapabilities': 'Pilih kemampuan yang dapat digunakan Marvi atas nama Anda.',
  ...
  'voice.providers.chip.cloud': 'Marvi (Terkelola)',
  'voice.providers.chip.cloudAria': 'Penyedia terkelola Marvi selalu aktif',
  ...
  'pttSettings.description':
    'Tahan sebuah tombol untuk berbicara dengan Marvi saat kamu sedang di aplikasi lain. Lepas tombol untuk mengirim; jika «Bacakan balasan» aktif, Marvi akan menyuarakan balasannya.',
  ...
  'pttSettings.errorAccessibility':
    'macOS memerlukan izin Aksesibilitas untuk pintasan ini. Buka Pengaturan Sistem → Privasi & Keamanan → Aksesibilitas lalu aktifkan Marvi.',
  ...
  'pttSettings.errorUnsupportedWayland':
    'Sesi Wayland belum mendukung pintasan global di Marvi — beralihlah ke sesi X11 atau gunakan tombol dikte di dalam aplikasi.',
  ...
  'chat.attachment.imageNotSupported':
    'Model ini tidak dapat membaca gambar. Anda dapat menggunakan tingkat Penalaran Marvi untuk melampirkan gambar Anda.',
  ...
  'bootCheck.desktopDescription':
    'Marvi memerlukan runtime untuk berpikir. Pilih di mana runtime harus berada.',
  'bootCheck.webDescription':
    'Di web, Marvi terhubung ke runtime yang Anda kendalikan. Masukkan URL dan token autentikasi di bawah, atau ambil aplikasi desktop untuk menjalankannya langsung di mesin Anda.',
  ...
  'bootCheck.legacyDescription':
    'Daemon Marvi yang diinstal terpisah sudah berjalan di perangkat ini. Kami perlu membersihkannya sebelum runtime bawaan dapat mengambil alih.',
  ...
  'bootCheck.portConflictBody':
    'Proses lain sedang menggunakan port jaringan yang dibutuhkan Marvi. Kami akan mencoba memperbaikinya secara otomatis.',
  ...
  'composio.expiredDescription':
    'Sambungkan kembali untuk mengaktifkan kembali alat {name}. Marvi akan membuat integrasi ini tidak tersedia sampai Anda menyegarkan akses OAuth.',
  ...
  'app.connectionIndicator.connected': 'Terhubung ke Marvi AI 🚀',
  ...
  'app.openhumanLink.notifications.sent':
    'Notifikasi uji telah dikirim. Jika Anda tidak menerimanya, buka System Settings → Notifications → Marvi, aktifkan Allow Notifications, dan atur Banner Style ke Persistent.',
  ...
  'app.routeLoading.initializing': 'Menginisialisasi Marvi...',
  ...
  'channels.authMode.managed_dm': 'Masuk dengan Marvi',
  ...
  'channels.discord.authMode.oauth.description':
    'Instal bot Marvi ke server Discord Anda melalui OAuth.',
  'channels.discord.authMode.managed_dm.description':
    'Tautkan akun Discord pribadi Anda ke bot Marvi.',
  ...
  'channels.telegram.authMode.managed_dm.description':
    'Kirim pesan langsung ke bot Marvi Telegram.',
  ...
  'iosPair.error.invalidQr': 'Kode QR tidak valid. Pastikan Anda memindai kode pairing Marvi.',
  ...
  'iosPair.instructions':
    'Buka Marvi di desktop Anda, buka Pengaturan > Perangkat, dan ketuk "Pasangkan ponsel" untuk menampilkan kode QR.',
  'iosPair.retryScan': 'Coba pindai lagi',
  'iosPair.scanQrCode': 'Pindai QR code',
  'iosPair.scannerOpening': 'Pemindai terbuka...',
  'iosPair.step.openDesktop': 'Buka Marvi di desktop',
  ...
  'composio.connect.permissionsNoteSuffix':
    'Izin agen milik Marvi dikendalikan di bawah sebagai sakelar read, write, dan admin.',
  ...
  'daemon.serviceBlockingGate.title': 'Core Marvi tidak tersedia',
  ...
  'intelligence.diagram.imageAlt': 'Diagram arsitektur Marvi terbaru yang dihasilkan',
  ...
  'settings.ai.openhumanDefault': 'Marvi (baku)',
  ...
  'settings.ai.routing.managedDesc':
    'Marvi akan menjalankan semua kesimpulan di awan, memilih model terbaik untuk tugas ini, mengoptimalkan biaya, dan menjaga standar routing teraman.',
  'settings.ai.routing.managedMsg':
    'Marvi akan menangani semua inferensi untuk setiap beban kerja dan secara otomatis memilih rute terbaik untuk biaya, kualitas, dan keamanan.',
  ...
  'settings.composio.confirmWarning':
    'Integrasi Anda yang sudah ada (Gmail, Slack, GitHub, dll. yang terhubung melalui Marvi) tidak akan terlihat — mereka berada di tenant Composio yang dikelola Marvi.',
  ...
  'settings.composio.modeManaged': 'Terkelola (Marvi menanganinya untuk Anda)',
  'settings.composio.modeManagedDesc':
    'Marvi mem-proxy pemanggilan tool melalui backend kami (disarankan). Autentikasi dibrokerkan; Anda tidak perlu menempel API key Composio. Webhook dirutekan sepenuhnya.',
  ...
  'settings.localModel.status.ollamaNotInstalledDesc':
    'Marvi kini memperlakukan Ollama sebagai runtime inferensi eksternal. Jalankan server Ollama Anda sendiri, tarik model yang diinginkan, lalu arahkan routing workload ke sana.',
  ...
  'settings.developerMenu.tools.desc':
    'Aktifkan atau nonaktifkan kemampuan yang bisa digunakan Marvi atas nama Anda',
  ...
  'settings.developerMenu.mcpServer.desc':
    'Konfigurasikan klien MCP eksternal untuk terhubung ke Marvi',
  ...
  'settings.mascot.colorAria': 'Warna Marvi',
  ...
  'settings.mascot.libraryUnavailable': 'Library Marvi tidak tersedia',
  'settings.mascot.title': 'Marvi',
  'settings.mascot.loadingLibrary': 'Memuat perpustakaan Marvi...',
  ...
  'settings.mascot.localDefault': 'Marvi Lokal (default)',
  'settings.mascot.menuTitle': 'Maskot',
  'settings.mascot.menuDesc': 'Pilih warna maskot yang digunakan di seluruh aplikasi',
  'settings.mascot.noCharacters': 'Belum ada karakter Marvi yang tersedia',
  ...
  'settings.memoryWindow.description':
    'Seberapa banyak konteks yang diingat Marvi dimasukkan ke setiap run agen baru. Jendela yang lebih besar terasa lebih sadar akan percakapan sebelumnya, tetapi menggunakan lebih banyak token — dan biaya lebih mahal — di setiap run.',
  ...
  'skills.meetingBots.busyTitle': 'Marvi sedang sibuk',
  'skills.meetingBots.comingSoon': 'Segera hadir',
  'skills.meetingBots.couldNotStartTitle': 'Tidak bisa memulai Marvi',
  'skills.meetingBots.displayName': 'Nama tampilan',
  'skills.meetingBots.failedToStart': 'Gagal memulai Marvi.',
  'skills.meetingBots.joiningMessage': 'Seharusnya muncul sebagai peserta dalam beberapa detik.',
  'skills.meetingBots.joiningTitle': 'Marvi bergabung ke rapat',
  'skills.meetingBots.meetingLink': 'Tautan rapat',
  'skills.meetingBots.modalAriaLabel': 'Kirim Marvi ke rapat',
  'skills.meetingBots.modalDesc': 'Deskripsi modal',
  'skills.meetingBots.modalTitle': 'Kirim Marvi ke rapat',
  ...
  'settings.mascot.noCharactersAvailable': 'Belum ada karakter Marvi yang tersedia',
  ...
  'settings.localModel.status.manageOllamaExternal':
    'Kelola proses Ollama dan unduhan model di luar Marvi, lalu jalankan ulang diagnostik.',
  ...
  'devOptions.menuToolsDesc':
    'Aktifkan atau nonaktifkan kemampuan yang dapat digunakan Marvi atas nama Anda',
  ...
  'keyring.consent.description':
    'Keychain sistem operasi Anda tidak dapat diakses. Marvi memerlukan izin Anda untuk menyimpan rahasia menggunakan penyimpanan lokal terenkripsi.',
  ...
  'memory.health.remediation.auth_missing':
    'Kredensial embedding tidak ditemukan. Masuk ke Marvi, atau siapkan embedding Ollama lokal di Pengaturan → AI → Sematan.',
  ...
  'onboarding.custom.vault.defaultDesc':
    'Gunakan default memori yang dikelola Marvi. Jalur vault dan kondisi sinkronisasi tetap dapat ditinjau nanti.',
  ...
  'onboarding.custom.vault.localDisabledReason':
    'Pengaturan terkelola memerlukan masuk Marvi dan tidak tersedia dalam mode lokal.',
  ...
  'vaultHealth.writableLabel': 'Vault dapat ditulis oleh Marvi',
  'vaultHealth.writableRecovery':
    'Marvi belum dapat menulis ke vault ini. Berikan izin tulis dan segarkan.',
  ...
  'memoryData.workspaceVaultDesc':
    'Marvi menulis catatan memori yang dihasilkan ke memory_tree/content.',
  ...
  'memoryData.internalFilesDesc':
    'Indeks, status antrean, dan ringkasan dikelola oleh Marvi agar pemanggilan dan sinkronisasi tetap sehat.',
