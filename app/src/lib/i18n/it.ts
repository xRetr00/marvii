...
const messages: TranslationMap = {
  ...
  'welcome.title': 'Benvenuto in Marvi',
  'welcome.subtitle':
  ...
  'welcome.resetErrorFallback':
    "Impossibile cancellare i dati dell'app. Chiudi e riapri Marvi, poi riprova.",
  ...
  'home.statusCoreUnreachable':
    'Il sidecar core locale non risponde. Il processo in background di Marvi potrebbe essersi bloccato o non essere partito.',
  ...
  'skills.explorer.emptyDescription':
    'Installa un pacchetto SKILL.md o inserisci cartelle in stile Hermes in the Marvi skills folder.',
  ...
  'rewards.localUnavailable':
    "L'accesso locale non guadagna ricompense, coupon o credito referral. Esci e continua accedendo con un account Marvi se vuoi che le ricompense vengano conteggiate.",
  ...
  'onboarding.welcome': 'Ciao. Sono Marvi.',
  ...
  'onboarding.finishDesc': 'Tutto pronto! Inizia a usare Marvi.',
  'onboarding.skip': 'Salta',
  'onboarding.getStarted': 'Inizia',
  'onboarding.runtimeChoice.title': 'Come vuoi eseguire Marvi?',
  ...
  'onboarding.runtimeChoice.cloud.tagline': 'Lascia che Marvi gestisca tutto per te.',
  ...
  'onboarding.custom.defaultSubtitle': 'Lascia che Marvi lo gestisca per te.',
  ...
  'onboarding.custom.inference.defaultDesc':
    'Marvi instrada ogni carico di lavoro a un modello predefinito sensato. Niente chiavi, niente configurazione.',
  ...
  'onboarding.custom.voice.defaultDesc':
    'Marvi include STT/TTS gestiti che funzionano subito. Niente da configurare.',
  ...
  'onboarding.custom.oauth.defaultDesc':
    'Marvi gestisce un workspace Composio gestito. Un clic per connettere ogni servizio in seguito.',
  ...
  'onboarding.custom.search.subtitle': 'Come Marvi cerca sul web per tuo conto.',
  'onboarding.custom.search.defaultDesc':
    'Marvi usa un backend di ricerca gestito. Nessuna chiave necessaria.',
  'onboarding.custom.search.configureDesc':
    'Porta la tua chiave di provider di ricerca (Tavily, Brave, ecc.). Configura in Impostazioni › Strumenti.',
  'onboarding.custom.embeddings.title': 'Embeddings',
  'onboarding.custom.embeddings.subtitle':
    'Come Marvi genera gli embedding vettoriali per la ricerca nella memoria semantica.',
  'onboarding.custom.embeddings.defaultDesc':
    'Marvi utilizza un servizio di embedding gestito. Nessuna chiave API necessaria.',
  ...
  'onboarding.custom.memory.subtitle':
    'Come Marvi ricorda il tuo contesto, le preferenze e le conversazioni precedenti.',
  'onboarding.custom.memory.defaultDesc':
    "Marvi gestisce automaticamente l'archiviazione e il recupero della memoria. Niente da configurare.",
  ...
  'misc.beta':
    'Marvi è in beta iniziale. Sentiti libero di condividere feedback o segnalare bug che incontri — ogni segnalazione ci aiuta a rilasciare più velocemente.',
  ...
  'privacy.shareAnonymizedDataDesc':
    'Aiuta a migliorare Marvi condividendo report di crash ed eventi di utilizzo limitati per la privacy, inclusi un ID account stabile e i metadati della versione dell’app. Messaggi, chiavi wallet, chiavi API e token di sessione non vengono mai raccolti.',
  ...
  'privacy.autoHandoffMeetDesc':
    "Quando termina una chiamata Google Meet, l'orchestratore di Marvi può leggere la trascrizione e svolgere azioni come redigere messaggi, pianificare follow-up o pubblicare riassunti nel tuo workspace Slack connesso. Disattivato di default.",
  ...
  'settings.search.menuDesc':
    'Imposta come predefinito la ricerca gestita da Marvi oppure collega il tuo provider con una chiave API.',
  'settings.search.description':
    "Scegli il motore di ricerca utilizzato dall'agente oppure disabilita completamente gli strumenti di ricerca. Gestito utilizza il backend di Marvi (nessuna configurazione). Parallelo, Brave e Querit vengono eseguiti direttamente dalla tua macchina usando la tua chiave API.",
  ...
  'settings.search.engineManagedLabel': 'Marvi Gestito',
  'settings.search.engineManagedDesc':
    'Predefinito. Instradato tramite il backend Marvi — nessuna chiave API necessaria.',
  'settings.search.localManagedUnavailable':
    'La ricerca gestita da Marvi non è disponibile per gli utenti locali. Aggiungi la tua chiave API Parallel o Brave per abilitare la ricerca web.',
  ...
  'devices.betaText':
    'Questa funzionalità è attualmente in beta. Associa i telefoni iOS a questo Marvi per usarli come client remoto.',
  ...
  'devices.emptyState':
    'Scansiona un codice QR sul tuo iPhone per collegarlo a questa sessione Marvi.',
  ...
  'devices.pairModal.instructions': "Apri l'app Marvi sul tuo iPhone e scansiona questo codice.",
  ...
  'mcp.connectAuth.oauthHint':
    'Questo server usa OAuth. Accedi tramite il tuo browser per autorizzare Marvi.',
  ...
  'autonomy.maxActionsHelp':
    'Numero massimo di azioni dello strumento che un agente può eseguire per ora continuativa. Il nuovo valore si applica alla prossima chat. I cron job e i listener dei canali mantengono il limite attuale fino al riavvio di Marvi.',
  ...
  'settings.billing.movedToWebDesc':
    "Le modifiche all'abbonamento, i metodi di pagamento, i crediti e le fatture sono ora gestiti su Marvi sul web.",
  ...
  'settings.tools.chooseCapabilities': 'Scegli quali capacità Marvi può usare per tuo conto.',
  ...
  'voice.providers.chip.cloud': 'Marvi (Gestito)',
  'voice.providers.chip.cloudAria': 'Il provider gestito da Marvi è sempre abilitato',
  ...
  'pttSettings.description':
    'Tieni premuto un tasto per parlare con Marvi mentre sei in un’altra app. Al rilascio l’audio viene inviato; se «Leggi le risposte» è attivo, Marvi risponde a voce.',
  ...
  'pttSettings.errorAccessibility':
    'macOS richiede l’autorizzazione Accessibilità per questa scorciatoia. Apri Impostazioni di sistema → Privacy e sicurezza → Accessibilità e attiva Marvi.',
  ...
  'pttSettings.errorUnsupportedWayland':
    'Le sessioni Wayland non supportano ancora le scorciatoie globali in Marvi — passa a una sessione X11 o usa l’interruttore di dettatura nell’app.',
  ...
  'chat.attachment.imageNotSupported':
    'Questo modello non può leggere le immagini. Puoi usare il livello Ragionamento di Marvi per allegare la tua immagine.',
  ...
  'backend.cloudDescription':
    "Modelli veloci e potenti instradati attraverso il backend di Marvi. Pronti all'uso immediatamente.",
  'backend.privacyNote':
  ...
  'bootCheck.desktopDescription':
    'Marvi ha bisogno di un runtime per pensare. Scegli dove farlo girare.',
  'bootCheck.webDescription':
    "Sul web, Marvi si connette a un runtime che controlli tu. Inserisci sotto URL e token di autenticazione, oppure scarica l'app desktop per farne girare uno direttamente sulla tua macchina.",
  ...
  'bootCheck.legacyDescription':
    'Un daemon Marvi installato separatamente è già in esecuzione su questo dispositivo. Dobbiamo rimuoverlo prima che il runtime integrato possa subentrare.',
  ...
  'bootCheck.portConflictBody':
    'Un altro processo sta usando la porta di rete necessaria a Marvi. Tenteremo di risolvere il problema automaticamente.',
  ...
  'welcome.localSessionDesc': 'Utilizza un profilo locale offline e salta Marvi OAuth.',
  ...
  'composio.expiredDescription':
    "Riconnettiti per riattivare gli strumenti {name}. Marvi manterrà questa integrazione non disponibile finché non aggiornerai l'accesso a OAuth.",
  ...
  'app.connectionIndicator.connected': 'Connesso a Marvi AI 🚀',
  ...
  'app.openhumanLink.notifications.sent':
    "Notifica di test inviata. Se non l'hai ricevuta, vai in Impostazioni di Sistema → Notifiche → Marvi, attiva Consenti notifiche e imposta lo Stile banner su Persistente.",
  ...
  'app.routeLoading.initializing': 'Inizializzazione di Marvi...',
  ...
  'channels.authMode.managed_dm': 'Accedi con Marvi',
  ...
  'channels.discord.authMode.oauth.description':
    'Installa il bot Marvi sul tuo server Discord tramite OAuth.',
  'channels.discord.authMode.managed_dm.description':
    'Collega il tuo account personale Discord al bot Marvi.',
  ...
  'channels.telegram.authMode.managed_dm.description':
    'Invia un messaggio direttamente al bot Marvi Telegram.',
  ...
  'iosPair.error.invalidQr':
    'Codice QR non valido. Assicurati di scansionare un codice di abbinamento Marvi.',
  ...
  'iosPair.instructions':
    'Apri Marvi sul desktop, vai in Impostazioni > Dispositivi e tocca "Associa telefono" per mostrare il codice QR.',
  'iosPair.retryScan': 'Riprova la scansione',
  'iosPair.scanQrCode': 'Scansione QR code',
  'iosPair.scannerOpening': 'Apertura scanner...',
  'iosPair.step.openDesktop': 'Apri Marvi sul desktop',
  ...
  'composio.connect.permissionsNoteSuffix':
    "Le autorizzazioni proprie dell'agente Marvi sono controllate sotto come toggle di lettura, scrittura e admin.",
  ...
  'daemon.serviceBlockingGate.title': 'Il core di Marvi non è disponibile',
  ...
  'intelligence.diagram.imageAlt': "Ultimo diagramma dell'architettura Marvi generato",
  ...
  'settings.ai.claudeCode.sandboxNoteMac':
    'Su macOS, the local Marvi profile rimane protetto dalla sandbox in entrambe le modalità.',
  ...
  'settings.ai.openhumanDefault': 'Marvi (predefinito)',
  ...
  'settings.ai.routing.managedDesc':
    'Marvi eseguirà tutte le inferenze nel cloud, sceglierà il miglior modello per il compito, ottimizzerà i costi e manterrà le impostazioni di routing più sicure.',
  'settings.ai.routing.managedMsg':
    'Marvi gestirà tutte le inferenze per ogni carico di lavoro e sceglierà automaticamente il percorso migliore in termini di costo, qualità e sicurezza.',
  ...
  'settings.composio.confirmWarning':
    'Le tue integrazioni esistenti (Gmail, Slack, GitHub, ecc. collegate tramite Marvi) non saranno visibili — risiedono nel tenant Composio gestito da Marvi.',
  ...
  'settings.composio.modeManaged': 'Gestita (Marvi lo gestisce per te)',
  'settings.composio.modeManagedDesc':
    "Marvi fa da proxy per le chiamate degli strumenti tramite il nostro backend (consigliato). L'autenticazione è mediata; non incolli mai una chiave API Composio. I webhook sono completamente instradati.",
  ...
  'settings.localModel.status.ollamaNotInstalledDesc':
    "Marvi ora tratta Ollama come un runtime di inferenza esterno. Avvia il tuo server Ollama, scarica i modelli che vuoi e punta l'instradamento dei carichi di lavoro su di esso.",
  ...
  'settings.developerMenu.tools.desc':
    'Abilita o disabilita le capacità che Marvi può usare per tuo conto',
  ...
  'settings.developerMenu.mcpServer.desc': 'Configura i client MCP esterni per connettersi a Marvi',
  ...
  'settings.mcpServer.toolsSectionDesc':
    "Strumenti esposti tramite il server MCP stdio durante l'esecuzione di Marvi core MCP",
  ...
  'settings.mcpServer.binaryPathNotFound':
    'Marvi binario non trovato. Se esegui dal sorgente, compila con: build the Marvi core binary',
  ...
  'settings.mascot.colorAria': 'Marvi colore',
  ...
  'settings.mascot.libraryUnavailable': 'Marvi libreria non disponibile',
  'settings.mascot.title': 'Marvi',
  'settings.mascot.loadingLibrary': 'Caricamento libreria Marvi…',
  ...
  'settings.mascot.localDefault': 'Marvi locale (predefinito)',
  'settings.mascot.menuTitle': 'Mascotte',
  'settings.mascot.menuDesc': "Scegli il colore della mascotte usato in tutta l'app",
  'settings.mascot.noCharacters': 'Nessun personaggio Marvi disponibile',
  ...
  'settings.memoryWindow.description':
    "Quanto contesto ricordato Marvi inietta in ogni nuova esecuzione dell'agente. Finestre più grandi fanno sentire l'agente più consapevole delle conversazioni passate ma usano più token — e costano di più — a ogni esecuzione.",
  ...
  'skills.create.scopeUserHint':
    'Scritto in the Marvi skills folder — disponibile in tutti i workspace.',
  ...
  'skills.install.errors.writeFailedHint':
    "La directory delle competenze dell'area di lavoro non era scrivibile. Controlla i permessi del filesystem per `the workspace Marvi skills folder`.",
  ...
  'skills.meetingBots.busyTitle': 'Marvi è occupato',
  'skills.meetingBots.comingSoon': 'In arrivo',
  'skills.meetingBots.couldNotStartTitle': 'Impossibile avviare Marvi',
  'skills.meetingBots.displayName': 'Nome visualizzato',
  'skills.meetingBots.failedToStart': 'Avvio di Marvi fallito.',
  'skills.meetingBots.joiningMessage': 'Apparirà come partecipante tra qualche secondo.',
  'skills.meetingBots.joiningTitle': 'Marvi si sta unendo alla riunione',
  'skills.meetingBots.meetingLink': 'Link della riunione',
  'skills.meetingBots.modalAriaLabel': 'Invia Marvi a una riunione',
  'skills.meetingBots.modalDesc': 'Descrizione modale',
  'skills.meetingBots.modalTitle': 'Invia Marvi a una riunione',
  ...
  'settings.mascot.noCharactersAvailable': 'Nessun personaggio Marvi disponibile',
  ...
  'settings.localModel.status.manageOllamaExternal':
    'Gestisci il processo Ollama e i pull dei modelli al di fuori di Marvi, poi riesegui la diagnostica.',
  ...
  'devOptions.menuToolsDesc':
    'Abilita o disabilita le funzionalità che Marvi può utilizzare per tuo conto',
  ...
  'keyring.consent.description':
    "Il portachiavi del sistema operativo non è accessibile. Marvi necessita del tuo permesso per archiviare i segreti utilizzando l'archiviazione locale crittografata.",
  ...
  'memory.health.remediation.auth_missing':
    'Nessuna credenziale per gli embedding trovata. Accedi a Marvi o configura embedding Ollama locali in Impostazioni → IA → Incorporamenti.',
  ...
  'onboarding.custom.vault.defaultDesc':
    'Usa le impostazioni di memoria predefinite gestite da Marvi. Il percorso del vault e la salute della sincronizzazione possono essere verificati in seguito.',
  ...
  'onboarding.custom.vault.localDisabledReason':
    'La configurazione gestita richiede il login a Marvi e non è disponibile in modalità locale.',
  ...
  'vaultHealth.writableLabel': 'Il vault è scrivibile da Marvi',
  'vaultHealth.writableRecovery':
    'Marvi non riesce ancora a scrivere in questo vault. Concedi i permessi di scrittura e aggiorna.',
  ...
  'memoryData.workspaceVaultDesc':
    'Marvi scrive le note di memoria generate in memory_tree/content.',
  ...
  'memoryData.internalFilesDesc':
    'Indici, stato della coda e riepiloghi sono gestiti da Marvi per mantenere efficiente il richiamo e la sincronizzazione.',
