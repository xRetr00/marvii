...
const messages: TranslationMap = {
  ...
  'welcome.resetErrorFallback': '无法清除应用数据。请退出并重新打开 Marvi，然后重试。',
  ...
  'home.statusCoreUnreachable': '本地核心 sidecar 无响应。Marvi 后台进程可能已崩溃或未能启动。',
  ...
  'skills.explorer.emptyDescription':
    '安装 SKILL.md 包，或将 Hermes 风格的文件夹放到 the Marvi skills folder 下。',
  ...
  'onboarding.finishDesc': '一切就绪！开始使用 Marvi。',
  'onboarding.skip': '跳过',
  'onboarding.getStarted': '开始使用',
  'onboarding.runtimeChoice.title': '你希望如何运行 Marvi？',
  'onboarding.runtimeChoice.subtitle': '选择最适合你的设置。之后可在设置中更改。',
  'onboarding.runtimeChoice.cloud.title': '简单模式',
  'onboarding.runtimeChoice.cloud.tagline': '让 Marvi 为你管理一切。',
  ...
  'onboarding.custom.defaultSubtitle': '让 Marvi 为你管理。',
  ...
  'onboarding.custom.inference.defaultDesc':
    'Marvi 会为每种工作负载路由到合适的默认模型。无需密钥，无需设置。',
  ...
  'onboarding.custom.voice.defaultDesc': 'Marvi 内置托管的 STT/TTS，开箱即用。无需额外配置。',
  ...
  'onboarding.custom.oauth.defaultDesc':
    'Marvi 使用托管的 Composio 工作区。之后每个服务都可一键连接。',
  'onboarding.custom.oauth.configureDesc':
    '使用你自己的 Composio 账户或 API 密钥。在设置 › 连接中配置。',
  'onboarding.custom.search.title': '网页搜索',
  'onboarding.custom.search.subtitle': 'Marvi 如何代表你搜索网页。',
  'onboarding.custom.search.defaultDesc': 'Marvi 使用托管搜索后端。无需密钥。',
  'onboarding.custom.search.configureDesc':
    '使用你自己的搜索提供商密钥（Tavily、Brave 等）。在设置 › 工具中配置。',
  'onboarding.custom.embeddings.title': 'Embeddings',
  'onboarding.custom.embeddings.subtitle': 'Marvi 生成向量嵌入以实现语义记忆搜索的方式。',
  'onboarding.custom.embeddings.defaultDesc': 'Marvi 使用托管嵌入服务，无需 API 密钥。',
  'onboarding.custom.embeddings.configureDesc':
    '使用您自己的嵌入服务提供商（OpenAI、Voyage、Ollama 等）。',
  'onboarding.custom.memory.title': '记忆',
  'onboarding.custom.memory.subtitle': 'Marvi 如何记住你的上下文、偏好和历史对话。',
  'onboarding.custom.memory.defaultDesc': 'Marvi 会自动管理记忆存储和检索。无需设置。',
  ...
  'privacy.shareAnonymizedDataDesc':
    '通过分享受隐私限制的崩溃报告和使用事件来帮助改进 Marvi，其中包括稳定的账号 ID 和应用版本元数据。我们绝不会收集消息、钱包密钥、API 密钥或会话令牌。',
  'privacy.meetingFollowUps': '会议跟进',
  'privacy.autoHandoffMeet': '自动将 Google Meet 转录交给编排器',
  'privacy.autoHandoffMeetDesc':
    '当 Google Meet 通话结束时，Marvi 的编排器可以阅读转录内容，并可能执行起草消息、安排跟进、或将摘要发布到已连接的 Slack 工作区等操作。默认关闭。',
  ...
  'settings.search.menuDesc': '默认使用 Marvi 托管搜索，或用 API 密钥接入你自己的提供商。',
  'settings.search.description':
    '选择智能体使用的搜索引擎。托管模式使用 Marvi 后端（无需设置）。Parallel、Brave 和 Querit 会用你的 API 密钥从本机直接调用。',
  'settings.search.engineAria': '搜索引擎',
  'settings.search.engineDisabledLabel': 'Disabled',
  'settings.search.engineDisabledDesc': '从智能体上下文和可用工具列表中移除搜索工具。',
  'settings.search.engineManagedLabel': 'Marvi 托管',
  'settings.search.engineManagedDesc': '默认选项。通过 Marvi 后端路由，无需 API 密钥。',
  'settings.search.localManagedUnavailable':
    '本地用户无法使用 Marvi 托管搜索。请添加你自己的 Parallel、Brave 或 Querit API 密钥以启用网页搜索。',
  ...
  'devices.pairModal.instructions': '打开 iPhone 上的 Marvi 应用程序并扫描此代码。',
  ...
  'mcp.connectAuth.oauthHint': '此服务器使用 OAuth。请通过浏览器登录以授权 Marvi。',
  ...
  'autonomy.maxActionsHelp':
    '智能体每滚动小时内可执行的最大工具操作次数。新值将在下次对话时生效。定时任务和频道监听器将保持当前限制，直到重启 Marvi。',
  ...
  'settings.billing.movedToWebDesc': '订阅变更、支付方式、配额和发票现在在 Marvi 网页上管理。',
  ...
  'settings.tools.chooseCapabilities': '选择 Marvi 可代表你使用的能力。',
  ...
  'voice.providers.chip.cloud': 'Marvi（托管）',
  'voice.providers.chip.cloudAria': 'Marvi 托管服务商始终启用',
  ...
  'pttSettings.description':
    '在其他应用中时，按住按键即可与 Marvi 对话。松开按键发送录音；若已开启「朗读回复」，Marvi 会用语音读出回复。',
  ...
  'pttSettings.errorAccessibility':
    '此快捷键需要 macOS 的辅助功能权限。请打开系统设置 → 隐私与安全 → 辅助功能，并启用 Marvi。',
  'pttSettings.errorShortcutInUse': '该快捷键已被其他应用占用。请选择其他快捷键。',
  'pttSettings.errorUnsupportedWayland':
    'Wayland 会话尚不支持 Marvi 的全局快捷键 — 请切换到 X11 会话，或使用应用内的听写开关。',
  ...
  'chat.attachment.imageNotSupported':
    '此模型无法读取图像。您可以使用 Marvi 推理层级来附加您的图像。',
  ...
  'bootCheck.desktopDescription': 'Marvi 需要一个运行中的核心才能工作。请选择连接方式。',
  'bootCheck.webDescription':
    '网页版 Marvi 连接到由你控制的远程核心。请输入其 URL 和认证令牌，或安装桌面版在本地运行核心。',
  ...
  'bootCheck.legacyDescription':
    '此设备上正在运行一个单独安装的 Marvi 守护进程。必须先将其移除，嵌入式核心才能接管。',
  ...
  'bootCheck.portConflictBody':
    '另一个进程正在占用 Marvi 所需的网络端口。我们将尝试自动修复此问题。',
  ...
  'welcome.localSessionDesc': '使用离线本地配置文件，跳过 Marvi OAuth。',
  ...
  'composio.expiredDescription':
    '重新连接以重新启用 {name} 工具。 Marvi 将保持此集成不可用，直到您刷新 OAuth 访问权限。',
  ...
  'app.connectionIndicator.connected': '已连接到 Marvi AI',
  ...
  'app.openhumanLink.notifications.blockedStep2': '找到 Marvi',
  ...
  'app.openhumanLink.notifications.sent':
    '测试通知已发送。如果未收到，请前往「系统设置 → 通知 → Marvi」，开启「允许通知」并将横幅样式设置为「持续」。',
  ...
  'app.routeLoading.initializing': '正在初始化 Marvi...',
  ...
  'channels.authMode.managed_dm': '使用 Marvi 登录',
  ...
  'channels.discord.authMode.oauth.description':
    '通过 OAuth 将 Marvi 机器人安装到你的 Discord 服务器。',
  'channels.discord.authMode.managed_dm.description':
    '将你的个人 Discord 账户关联到 Marvi 机器人。',
  ...
  'channels.telegram.authMode.managed_dm.description': '直接向 Marvi Telegram 机器人发送消息。',
  ...
  'composio.connect.permissionsNoteSuffix':
    'Marvi 自身的智能体权限通过下方的读取、写入和管理员开关控制。',
  ...
  'daemon.serviceBlockingGate.title': 'Marvi 核心不可用',
  ...
  'intelligence.diagram.imageAlt': '最新生成的 Marvi 架构图',
  ...
  'settings.ai.claudeCode.sandboxNoteMac':
    '在 macOS 上，两种模式下 the local Marvi profile 都受沙盒保护。',
  ...
  'settings.ai.openhumanDefault': 'Marvi（默认）',
  ...
  'settings.ai.routing.managedDesc':
    'Marvi 会在云端运行所有推理，为任务选择最佳模型，优化成本，并保持最安全的路由默认值。',
  'settings.ai.routing.managedMsg':
    'Marvi 会处理每个工作负载的全部推理，并自动选择兼顾成本、质量和安全性的最佳路线。',
  ...
  'settings.composio.confirmWarning':
    '你现有的集成（通过 Marvi 关联的 Gmail、Slack、GitHub 等）将不可见——它们存放在 Marvi 托管的 Composio 租户中。',
  ...
  'settings.composio.modeManaged': '托管（由 Marvi 管理）',
  'settings.composio.modeManagedDesc':
    'Marvi 通过我们的后端代理工具调用（推荐）。认证由我们处理，你无需粘贴 Composio API 密钥。Webhook 完全路由。',
  ...
  'settings.localModel.status.ollamaNotInstalledDesc':
    'Marvi 现在将 Ollama 视为外部推理运行时。请启动你自己的 Ollama 服务器，拉取所需模型，并将工作负载路由指向它。',
  ...
  'settings.developerMenu.tools.desc': '启用或停用 Marvi 可代表你使用的能力',
  ...
  'settings.developerMenu.mcpServer.desc': '配置外部 MCP 客户端以连接到 Marvi',
  ...
  'settings.mcpServer.toolsSectionDesc': '运行 Marvi core MCP 时通过 MCP stdio 服务器暴露的工具',
  ...
  'settings.mascot.characterDesc': '选择你的 Marvi 角色',
  ...
  'settings.mascot.colorAria': 'Marvi 颜色',
  ...
  'settings.memoryWindow.description':
    'Marvi 在每次新的智能体运行中注入多少记忆上下文。更大的窗口对过往对话更有感知，但每次运行会消耗更多 token，成本也更高。',
  ...
  'skills.create.scopeUserHint': '写入 the Marvi skills folder — 在所有工作空间中可用。',
  ...
  'skills.meetingBots.bannerDesc': '让 Marvi 加入你的会议，自动记录摘要',
  'skills.meetingBots.bannerTitle': '会议机器人',
  'skills.meetingBots.busyTitle': 'Marvi 正忙',
  'skills.meetingBots.comingSoon': '即将推出',
  'skills.meetingBots.couldNotStartTitle': '无法启动 Marvi',
  'skills.meetingBots.displayName': '显示名称',
  'skills.meetingBots.failedToStart': '启动 Marvi 失败。',
  'skills.meetingBots.joiningMessage': '它应该在几秒钟内作为参会者出现。',
  'skills.meetingBots.joiningTitle': 'Marvi 正在加入会议',
  'skills.meetingBots.meetingLink': '会议链接',
  'skills.meetingBots.modalAriaLabel': '将 Marvi 发送到会议',
  'skills.meetingBots.modalDesc': '输入会议链接，让 Marvi 作为参会者加入并记录内容。',
  'skills.meetingBots.modalTitle': '将 Marvi 发送到会议',
  ...
  'settings.mascot.noCharactersAvailable': '暂无可用的 Marvi 角色',
  ...
  'settings.localModel.status.manageOllamaExternal':
    '请在 Marvi 之外管理 Ollama 进程和模型拉取，然后重新运行诊断。',
  ...
  'devOptions.menuToolsDesc': '启用或禁用 Marvi 可代表你使用的能力',
  ...
  'keyring.consent.description':
    '您的操作系统密钥链不可访问。Marvi 需要您的许可，以便使用本地加密存储来保存密钥。',
  ...
  'memory.health.remediation.auth_missing':
    '未找到嵌入凭据。请登录 Marvi，或在设置 → AI → 向量嵌入 中设置本地 Ollama 嵌入。',
  ...
  'onboarding.custom.vault.defaultDesc':
    '使用 Marvi 托管的记忆默认设置。保险库路径和同步健康状态仍可稍后查看。',
  'onboarding.custom.vault.configureDesc': '立即查看保险库所有权、运行健康检查并调整记忆控制。',
  'onboarding.custom.vault.localDisabledReason': '托管设置需要登录 Marvi，在本地模式下不可用。',
  ...
  'vaultHealth.writableLabel': 'Marvi 可写入保险库',
  'vaultHealth.writableRecovery': 'Marvi 暂时无法写入此保险库。请授予写入权限后刷新。',
  ...
  'memoryData.workspaceVaultDesc': 'Marvi 将生成的记忆笔记写入 memory_tree/content。',
  ...
  'memoryData.internalFilesDesc': '索引、队列状态和摘要由 Marvi 管理，以保持召回和同步的正常运行。',
