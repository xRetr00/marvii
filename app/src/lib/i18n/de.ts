...
const messages: TranslationMap = {
  ...
  'welcome.title': 'Willkommen bei Marvi',
  'welcome.subtitle':
  ...
  'welcome.resetErrorFallback':
    'App-Daten konnten nicht gelöscht werden. Bitte Marvi beenden, neu öffnen und es dann erneut versuchen.',
  ...
  'home.statusCoreUnreachable':
    'Der lokale Core-Sidecar reagiert nicht. Der Hintergrundprozess Marvi ist möglicherweise abgestürzt oder konnte nicht gestartet werden.',
  ...
  'skills.explorer.emptyDescription':
    'Installiere ein SKILL.md-Paket oder lege Hermes-artige Ordner unter the Marvi skills folder ab.',
  ...
  'rewards.localUnavailable':
    'Ein lokaler Login sammelt keine Belohnungen, Gutscheine oder Empfehlungsguthaben. Melde dich ab und anschließend mit einem Marvi-Konto an, wenn Belohnungen zählen sollen.',
  ...
  'onboarding.welcome': 'Hallo. Ich bin Marvi.',
  ...
  'onboarding.finishDesc': 'Du bist bereit! Beginne mit der Verwendung von Marvi.',
  'onboarding.skip': 'Überspringen',
  'onboarding.getStarted': 'Lege los',
  'onboarding.runtimeChoice.title': 'Wie möchtest du Marvi starten?',
  ...
  'onboarding.runtimeChoice.cloud.tagline': 'Lass Marvi alles für dich verwalten.',
  ...
  'onboarding.custom.defaultSubtitle': 'Lass Marvi das für dich erledigen.',
  ...
  'onboarding.custom.inference.defaultDesc':
    'Marvi leitet jede Arbeitslast an ein sinnvolles Standardmodell weiter. Keine Schlüssel, keine Einrichtung.',
  ...
  'onboarding.custom.voice.defaultDesc':
    'Marvi wird mit verwaltetem STT/TTS geliefert, das einfach funktioniert. Nichts zu verkabeln.',
  ...
  'onboarding.custom.oauth.defaultDesc':
    'Marvi führt einen verwalteten Composio-Arbeitsbereich aus. Ein Klick, um jeden Dienst später zu verbinden.',
  ...
  'onboarding.custom.search.subtitle': 'Wie Marvi das Web in deinem Namen durchsucht.',
  'onboarding.custom.search.defaultDesc':
    'Marvi verwendet ein verwaltetes Such-Backend. Keine Schlüssel erforderlich.',
  ...
  'onboarding.custom.embeddings.subtitle':
    'Wie Marvi Vektor-Embeddings für die semantische Gedächtnissuche erstellt.',
  'onboarding.custom.embeddings.defaultDesc':
    'Marvi verwendet einen verwalteten Embedding-Dienst. Kein API-Schlüssel erforderlich.',
  ...
  'onboarding.custom.memory.subtitle':
    'Wie Marvi sich deinen Kontext, deine Vorlieben und frühere Gespräche merkt.',
  'onboarding.custom.memory.defaultDesc':
    'Marvi verwaltet die Speicherung und den Abruf des Speichers automatisch. Nichts einzurichten.',
  ...
  'misc.beta':
    'Marvi befindet sich in der frühen Betaphase. Teile uns gerne dein Feedback mit oder melde Fehler, auf die du stößt – jede Meldung hilft uns, schneller zu liefern.',
  ...
  'privacy.shareAnonymizedDataDesc':
    'Hilf mit, Marvi zu verbessern, indem du datensparsame Absturzberichte und Nutzungsereignisse teilst, einschließlich einer stabilen Konto-ID und App-Versionsmetadaten. Nachrichten, Wallet-Schlüssel, API-Schlüssel und Sitzungstokens werden nie erfasst.',
  ...
  'privacy.autoHandoffMeetDesc':
    'Wenn ein Google Meet-Anruf endet, kann der Orchestrator von Marvi das Transkript lesen und Maßnahmen wie das Verfassen von Nachrichten, das Planen von Folgemaßnahmen oder das Veröffentlichen von Zusammenfassungen in deinem verbundenen Slack-Arbeitsbereich ergreifen. Standardmäßig deaktiviert.',
  ...
  'settings.search.menuDesc':
    'Verwenden Sie standardmäßig die von Marvi verwaltete Suche oder verbinden Sie Ihren eigenen Anbieter mit einem API-Schlüssel.',
  'settings.search.description':
    'Wählen Sie die Suchmaschine, die der Agent verwendet, oder deaktivieren Sie Suchwerkzeuge vollständig. „Verwaltet“ nutzt das Backend von Marvi (keine Einrichtung erforderlich). Parallel, Brave und Querit laufen direkt von Ihrem Gerät aus und verwenden Ihren API-Schlüssel.',
  ...
  'settings.search.engineManagedLabel': 'Marvi Verwaltet',
  'settings.search.engineManagedDesc':
    'Standard. Wird über das Marvi-Backend weitergeleitet – kein API-Schlüssel erforderlich.',
  'settings.search.localManagedUnavailable':
    'Die von Marvi verwaltete Suche ist für lokale Benutzer nicht verfügbar. Füge deinen eigenen Parallel- oder Brave-API-Schlüssel hinzu, um die Websuche zu aktivieren.',
  ...
  'devices.betaText':
    'Diese Funktion befindet sich derzeit in der Beta-Phase. Koppele iOS-Geräte mit diesem Marvi, um sie als Remote-Client zu verwenden.',
  ...
  'devices.emptyState':
    'Scanne einen QR-Code auf deinem iPhone, um es mit dieser Marvi-Sitzung zu verbinden.',
  ...
  'devices.pairModal.instructions': 'Öffne die Marvi-App auf deinem iPhone und scanne diesen Code.',
  ...
  'mcp.connectAuth.oauthHint':
    'Dieser Server verwendet OAuth. Melden Sie sich über Ihren Browser an, um Marvi zu autorisieren.',
  ...
  'autonomy.maxActionsHelp':
    'Maximale Anzahl von Tool-Aktionen, die ein Agent pro rollierender Stunde ausführen darf. Der neue Wert gilt ab dem nächsten Chat. Cron-Jobs und Kanal-Listener behalten ihr aktuelles Limit, bis Marvi neu gestartet wird.',
  ...
  'settings.billing.movedToWebDesc':
    'Abonnementänderungen, Zahlungsmethoden, Gutschriften und Rechnungen werden jetzt bei Marvi im Internet verwaltet.',
  ...
  'settings.tools.chooseCapabilities':
    'Wähle aus, welche Funktionen Marvi in deinem Namen nutzen kann.',
  ...
  'voice.providers.chip.cloud': 'Marvi (Verwaltet)',
  'voice.providers.chip.cloudAria': 'Verwalteter Marvi-Anbieter ist immer aktiv',
  ...
  'pttSettings.description':
    'Halte eine Taste gedrückt, um mit Marvi zu sprechen, während du eine andere App nutzt. Loslassen sendet die Aufnahme; wenn „Antworten vorlesen" aktiviert ist, antwortet Marvi per Sprachausgabe.',
  ...
  'pttSettings.errorAccessibility':
    'macOS benötigt für dieses Tastenkürzel die Bedienungshilfen-Berechtigung. Öffne Systemeinstellungen → Datenschutz & Sicherheit → Bedienungshilfen und aktiviere Marvi.',
  ...
  'pttSettings.errorUnsupportedWayland':
    'Wayland-Sitzungen unterstützen globale Tastenkürzel in Marvi noch nicht — wechsle zu einer X11-Sitzung oder nutze den In-App-Diktierschalter.',
  ...
  'chat.attachment.imageNotSupported':
    'Dieses Modell kann keine Bilder lesen. Du kannst die Marvi-Stufe „Denkmodus“ verwenden, um dein Bild anzuhängen.',
  ...
  'bootCheck.desktopDescription':
    'Marvi benötigt eine Laufzeit zum Nachdenken. Wähle, wo es leben soll.',
  'bootCheck.webDescription':
    'Im Web stellt Marvi eine Verbindung zu einer von dir gesteuerten Laufzeit her. Gib unten den URL und das Authentifizierungstoken ein oder greife auf die Desktop-App zu, um eine direkt auf deinem Computer auszuführen.',
  ...
  'bootCheck.legacyDescription':
    'Auf diesem Gerät läuft bereits ein separat installierter Marvi-Daemon. Wir müssen es bereinigen, bevor die integrierte Laufzeit übernehmen kann.',
  ...
  'bootCheck.portConflictBody':
    'Ein anderer Prozess nutzt den Netzwerkport, den Marvi benötigt. Wir versuchen, das automatisch zu beheben.',
  ...
  'welcome.localSessionDesc': 'Verwendet ein lokales Offline-Profil und überspringt Marvi OAuth.',
  ...
  'composio.expiredDescription':
    'Stellen Sie die Verbindung erneut her, um {name}-Tools erneut zu aktivieren. Marvi sorgt dafür, dass diese Integration nicht verfügbar bleibt, bis Sie den OAuth-Zugriff aktualisieren.',
  ...
  'app.connectionIndicator.connected': 'Verbunden mit Marvi AI 🚀',
  ...
  'app.openhumanLink.notifications.sent':
    'Testbenachrichtigung gesendet. Wenn du sie nicht erhalten hast, gehe zu Systemeinstellungen → Benachrichtigungen → Marvi, aktiviere „Benachrichtigungen zulassen“ und stelle den Bannerstil auf „Persistent“ ein.',
  ...
  'app.routeLoading.initializing': 'Marvi wird initialisiert...',
  ...
  'channels.authMode.managed_dm': 'Mit Marvi anmelden',
  ...
  'channels.discord.authMode.oauth.description':
    'Installiere den Marvi-Bot über OAuth auf deinem Discord-Server.',
  'channels.discord.authMode.managed_dm.description':
    'Verknüpfe dein persönliches Discord-Konto mit dem Marvi-Bot.',
  ...
  'channels.telegram.authMode.managed_dm.description': 'Schreibe dem Marvi-Telegram-Bot direkt.',
  ...
  'iosPair.error.invalidQr':
    'Ungültiger QR-Code. Sicherstellen, dass ein Marvi-Kopplungscode gescannt wird.',
  ...
  'iosPair.instructions':
    "Öffne Marvi auf dem Desktop, gehe zu Einstellungen > Geräte und tippe auf 'Gerät koppeln', um den QR-Code anzuzeigen.",
  'iosPair.retryScan': 'Scan erneut versuchen',
  'iosPair.scanQrCode': 'Scannen QR code',
  'iosPair.scannerOpening': 'Scanner wird geöffnet...',
  'iosPair.step.openDesktop': 'Marvi auf dem Desktop öffnen',
  ...
  'composio.connect.permissionsNoteSuffix':
    'Die eigenen Agentenberechtigungen von Marvi werden unten als Lese-, Schreib- und Admin-Umschaltung gesteuert.',
  ...
  'daemon.serviceBlockingGate.title': 'Marvi Kern ist nicht verfügbar',
  ...
  'intelligence.diagram.imageAlt': 'Zuletzt generiertes Marvi-Architekturdiagramm',
  ...
  'settings.ai.claudeCode.sandboxNoteMac':
    'Unter macOS bleibt the local Marvi profile in beiden Modi durch die Sandbox geschützt.',
  ...
  'settings.ai.openhumanDefault': 'Marvi (Standard)',
  ...
  'settings.ai.routing.managedDesc':
    'Marvi führt alle Inferenzen in der Cloud aus, wählt das beste Modell für die Aufgabe aus, optimiert die Kosten und behält die sichersten Routing-Standards bei.',
  'settings.ai.routing.managedMsg':
    'Marvi verarbeitet alle Rückschlüsse für jede Arbeitsbelastung und wählt automatisch die beste Route für Kosten, Qualität und Sicherheit.',
  ...
  'settings.composio.confirmWarning':
    'Deine vorhandenen Integrationen (Gmail, Slack, GitHub usw., die über Marvi verknüpft sind) sind nicht sichtbar – sie befinden sich im von Marvi verwalteten Composio-Mandanten.',
  ...
  'settings.composio.modeManaged': 'Verwaltet (Marvi erledigt das für dich)',
  'settings.composio.modeManagedDesc':
    'Marvi leitet Tool-Aufrufe über unser Backend weiter (empfohlen). Auth wird vermittelt; du fügst niemals einen Composio API-Schlüssel ein. Webhooks werden vollständig weitergeleitet.',
  ...
  'settings.localModel.status.ollamaNotInstalledDesc':
    'Marvi behandelt jetzt Ollama als externe Inferenzlaufzeit. Starte deinen eigenen Ollama-Server, rufe die gewünschten Modelle ab und richte das Workload-Routing darauf aus.',
  ...
  'settings.developerMenu.tools.desc':
    'Aktiviere oder deaktiviere Funktionen, die Marvi in deinem Namen nutzen kann',
  ...
  'settings.developerMenu.mcpServer.desc':
    'Konfiguriere externe MCP-Clients für die Verbindung mit Marvi',
  ...
  'settings.mcpServer.toolsSectionDesc':
    'Werkzeuge, die über den MCP-stdio-Server bereitgestellt werden, wenn Marvi core MCP ausgeführt wird',
  ...
  'settings.mcpServer.binaryPathNotFound':
    'Marvi-Binärdatei nicht gefunden. Wenn du aus dem Quellcode arbeitest, baue sie mit: build the Marvi core binary',
  ...
  'settings.mascot.colorAria': 'Marvi Farbe',
  ...
  'settings.mascot.libraryUnavailable': 'Marvi Bibliothek nicht verfügbar',
  'settings.mascot.title': 'Marvi',
  'settings.mascot.loadingLibrary': 'Marvi-Bibliothek wird geladen…',
  ...
  'settings.mascot.localDefault': 'Lokal Marvi (Standard)',
  ...
  'settings.mascot.noCharacters': 'Es sind noch keine Marvi Zeichen verfügbar',
  ...
  'settings.memoryWindow.description':
    'Wie viel gespeicherter Kontext Marvi in jede neue Agentenausführung eingefügt wird. Bei größeren Fenstern ist man sich früherer Gespräche besser bewusst, verbraucht aber bei jedem Durchlauf mehr Token – und kostet mehr.',
  ...
  'skills.create.scopeUserHint':
    'Geschrieben an the Marvi skills folder – verfügbar in allen Arbeitsbereichen.',
  ...
  'skills.install.errors.writeFailedHint':
    'Das Workspace-Skills-Verzeichnis war nicht beschreibbar. Überprüfen Sie die Dateisystemberechtigungen für „the workspace Marvi skills folder“.',
  ...
  'skills.meetingBots.bannerDesc':
    'Lege einen Google Meet-Link ab und Marvi tritt als Gast bei, spricht, hört zu und winkt zurück.',
  'skills.meetingBots.bannerTitle': 'Sende Marvi an eine Besprechung',
  'skills.meetingBots.busyTitle': 'Marvi ist beschäftigt',
  'skills.meetingBots.comingSoon': 'Kommt bald',
  'skills.meetingBots.couldNotStartTitle': 'Marvi konnte nicht gestartet werden',
  'skills.meetingBots.displayName': 'Anzeigename',
  'skills.meetingBots.failedToStart': 'Marvi konnte nicht gestartet werden.',
  'skills.meetingBots.joiningMessage': 'Es sollte in wenigen Sekunden als Teilnehmer erscheinen.',
  'skills.meetingBots.joiningTitle': 'Marvi nimmt an der Besprechung teil',
  'skills.meetingBots.meetingLink': 'Link zum Treffen',
  'skills.meetingBots.modalAriaLabel': 'Sende Marvi an eine Besprechung',
  'skills.meetingBots.modalDesc':
    'Marvi tritt als anonymer Gast bei, streamt sein Video in den Anruf und antwortet über den Agenten.',
  'skills.meetingBots.modalTitle': 'Sende Marvi an eine Besprechung',
  ...
  'settings.mascot.noCharactersAvailable': 'Es sind noch keine Marvi Zeichen verfügbar',
  ...
  'settings.localModel.status.manageOllamaExternal':
    'Verwalte den Ollama-Prozess und die Modell-Pulls außerhalb von Marvi, und führe dann die Diagnose erneut aus.',
  ...
  'keyring.consent.description':
    'Der Schlüsselbund Ihres Betriebssystems ist nicht erreichbar. Marvi benötigt Ihre Erlaubnis, Geheimnisse stattdessen in einem lokal verschlüsselten Speicher abzulegen.',
  ...
  'memory.health.remediation.auth_missing':
    'Keine Embeddings-Anmeldedaten gefunden. Melde dich bei Marvi an oder richte lokale Ollama-Embeddings unter Einstellungen → KI → Einbettungen ein.',
  ...
  'onboarding.custom.vault.defaultDesc':
    'Von Marvi verwaltete Standardspeichereinstellungen verwenden. Vault-Pfad und Synchronisierungsstatus können später eingesehen werden.',
  ...
  'onboarding.custom.vault.localDisabledReason':
    'Die verwaltete Einrichtung erfordert eine Marvi-Anmeldung und ist im lokalen Modus nicht verfügbar.',
  ...
  'vaultHealth.writableLabel': 'Vault ist durch Marvi beschreibbar',
  'vaultHealth.writableRecovery':
    'Marvi kann noch nicht in diesen Vault schreiben. Schreibberechtigungen erteilen und aktualisieren.',
  ...
  'memoryData.workspaceVaultDesc':
    'Marvi schreibt generierte Speichernotizen nach memory_tree/content.',
  ...
  'memoryData.internalFilesDesc':
    'Indizes, Warteschlangenstatus und Zusammenfassungen werden von Marvi verwaltet, um Erinnerung und Synchronisierung fehlerfrei zu halten.',
