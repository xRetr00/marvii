...
const en: TranslationMap = {
  ...
  'welcome.title': 'Welcome to Marvi',
  'welcome.subtitle':
  ...
  'welcome.resetErrorFallback':
    'Could not clear app data. Please quit and reopen Marvi, then try again.',
  ...
  'home.statusCoreUnreachable':
    "The Marvi core isn't responding. The background process may have crashed or failed to start.",
  ...
  'memory.health.remediation.auth_missing':
    'No embeddings credentials found. Log in to Marvi, or set up local Ollama embeddings in Settings → AI → Embeddings.',
  ...
  // Onboarding
  'onboarding.welcome': "Hi. I'm Marvi.",
  ...
  'onboarding.finishDesc': "You're all set! Start using Marvi.",
  'onboarding.skip': 'Skip',
  'onboarding.getStarted': 'Get Started',

  // Onboarding: runtime-choice step (Cloud vs Custom)
  'onboarding.runtimeChoice.title': 'How would you like to run Marvi?',
  'onboarding.runtimeChoice.subtitle':
    'Pick how much Marvi manages for you. You can change this later in Settings.',
  'onboarding.runtimeChoice.cloud.title': 'Simple',
  'onboarding.runtimeChoice.cloud.tagline':
    'Use Marvi-hosted sign-in, model routing, search, and managed integrations.',
  ...
  'onboarding.runtimeChoice.custom.tagline':
    'Bring your own keys. Choose which services Marvi should call.',
  ...
  'onboarding.custom.defaultSubtitle': 'Let Marvi manage it for you.',
  ...
  'onboarding.custom.inference.defaultDesc':
    'Marvi routes workloads through its managed backend by default. No keys, no setup.',
  ...
  'onboarding.custom.voice.defaultDesc':
    'Marvi ships with managed STT/TTS providers that may send audio/text to hosted services.',
  ...
  'onboarding.custom.oauth.defaultDesc':
    'Marvi brokers OAuth and tool calls through a managed Composio workspace.',
  ...
  'onboarding.custom.search.subtitle': 'How Marvi searches the web on your behalf.',
  'onboarding.custom.search.defaultDesc':
    'Marvi uses a managed search proxy by default. No search API key needed.',
  ...
  'onboarding.custom.embeddings.subtitle':
    'How Marvi generates vector embeddings for semantic memory search.',
  'onboarding.custom.embeddings.defaultDesc':
    'Marvi uses a managed embedding service. No API key needed.',
  ...
  'onboarding.custom.vault.defaultDesc':
    'Use Marvi-managed memory defaults. Vault path and sync health can still be reviewed later.',
  ...
  'onboarding.custom.memory.subtitle':
    'How Marvi remembers your context, preferences, and prior conversations.',
  'onboarding.custom.memory.defaultDesc':
    'Marvi manages memory storage and retrieval automatically. Nothing to set up.',
  ...
  'misc.beta':
    'Marvi is in early beta. Feel free to share feedback or report any bugs you run into — every report helps us ship faster.',
  ...
  'settings.search.menuDesc':
    'Default to Marvi-managed search or wire up your own provider with an API key.',
  'settings.search.description':
    "Pick the search engine the agent uses, or disable search tools entirely. Managed uses Marvi's backend (no setup). Parallel, Brave, and Querit run direct from your machine using your API key.",
  'settings.search.engineAria': 'Search engine',
  'settings.search.engineDisabledLabel': 'Disabled',
  'settings.search.engineDisabledDesc':
    'Remove search tools from the agent context and available tool list.',
  'settings.search.engineManagedLabel': 'Marvi Managed',
  'settings.search.engineManagedDesc':
    'Default. Routed through the Marvi backend — no API key required.',
  'settings.search.localManagedUnavailable':
    'Marvi Managed search is not available for local users. Add your own Parallel, Brave, or Querit API key to enable web search.',
  ...
  'devices.betaText':
    'This feature is currently in beta. Pair iOS phones with this Marvi to use them as a remote client.',
  ...
  'devices.emptyState': 'Scan a QR code on your iPhone to connect it to this Marvi session.',
  ...
  'devices.pairModal.instructions': 'Open the Marvi app on your iPhone and scan this code.',
  ...
  'mcp.connectAuth.oauthHint':
    'This server uses OAuth. Sign in through your browser to authorize Marvi.',
  ...
  'autonomy.maxActionsHelp':
    'Maximum tool actions an agent can run per rolling hour. New value applies to your next chat. Cron jobs and channel listeners keep their current limit until you restart Marvi.',
  ...
  // Settings: Tools
  'settings.tools.chooseCapabilities': 'Choose which capabilities Marvi can use on your behalf.',
  ...
  'voice.providers.cloudWhisperProxy': 'Marvi (Managed)',
  ...
  'voice.providers.cloudElevenLabsProxy': 'Marvi (Managed)',
  ...
  'voice.providers.chip.cloud': 'Marvi (Managed)',
  'voice.providers.chip.cloudAria': 'Marvi managed provider is always enabled',
  ...
  'pttSettings.description':
    "Hold a key to talk to Marvi while you're in another app. Release the key to send; Marvi speaks the reply if 'Speak agent replies' is on.",
  ...
  'pttSettings.errorAccessibility':
    'macOS needs Accessibility permission for this shortcut. Open System Settings → Privacy & Security → Accessibility and enable Marvi.',
  ...
  'pttSettings.errorUnsupportedWayland':
    "Wayland sessions don't support global shortcuts in Marvi yet — switch to an X11 session or use the in-app dictation toggle.",
  ...
  'chat.attachment.imageNotSupported':
    'This model can’t read images. You can use the Marvi Reasoning tier to attach your image.',
  ...
  'vaultHealth.writableLabel': 'Vault is writable by Marvi',
  'vaultHealth.writableRecovery':
    'Marvi cannot write to this vault yet. Grant write permissions and refresh.',
  ...
  'memoryData.workspaceVaultDesc': 'Marvi writes generated memory notes to memory_tree/content.',
  ...
  'memoryData.internalFilesDesc':
    'Indexes, queue state, and summaries are managed by Marvi to keep recall and sync healthy.',
  ...
  'backend.cloudDescription':
    'Fast, powerful models routed through the Marvi backend. Ready to use immediately.',
  'backend.privacyNote':
  ...
  'bootCheck.desktopDescription': 'Marvi needs a runtime to think. Pick where it should live.',
  'bootCheck.webDescription':
    'On the web, Marvi connects to a runtime you control. Drop in its URL and auth token below, or grab the desktop app to run one right on your machine.',
  ...
  'bootCheck.legacyDescription':
    'A separately-installed Marvi daemon is already running on this device. We need to clear it out before the built-in runtime can take over.',
  ...
  'bootCheck.portConflictBody':
    "Another process is using the network port Marvi needs. We'll try to fix this automatically.",
  ...
  'composio.expiredDescription':
    'Reconnect to re-enable {name} tools. Marvi will keep this integration unavailable until you refresh OAuth access.',
  ...
  'app.connectionIndicator.connected': 'Connected to Marvi AI 🚀',
  ...
  'app.openhumanLink.accounts.intro': 'Connect your apps to give Marvi access to your accounts.',
  ...
  'app.openhumanLink.notifications.blockedStep2': 'Go to Notifications → Marvi',
  'app.openhumanLink.notifications.blockedStep3': 'Enable Allow Notifications',
  'app.openhumanLink.notifications.intro': 'Allow Marvi to send you notifications.',
  ...
  'app.openhumanLink.notifications.sent':
    "Test notification sent. If you didn't receive it, go to System Settings → Notifications → Marvi, turn on Allow Notifications, and set Banner Style to Persistent.",
  ...
  'app.routeLoading.initializing': 'Initializing Marvi...',
  ...
  // Auth mode labels
  'channels.authMode.managed_dm': 'Login with Marvi',
  ...
  'channels.discord.authMode.oauth.description':
    'Install the Marvi bot to your Discord server via OAuth.',
  'channels.discord.authMode.managed_dm.description':
    'Link your personal Discord account to the Marvi bot.',
  ...
  'channels.telegram.authMode.managed_dm.description': 'Message the Marvi Telegram bot directly.',
  ...
  'iosPair.instructions':
    'Open Marvi on your desktop, go to Settings > Devices, and tap "Pair phone" to show the QR code.',
  'iosPair.retryScan': 'Retry scan',
  'iosPair.scanQrCode': 'Scan QR code',
  'iosPair.scannerOpening': 'Scanner opening...',
  'iosPair.step.openDesktop': 'Open Marvi on desktop',
  ...
  'composio.connect.permissionsNoteSuffix':
    "Marvi's own agent permissions are controlled below as read, write, and admin toggles.",
  ...
  'daemon.serviceBlockingGate.title': 'Marvi core is unavailable',
  'home.banners.discordSubtitle': 'Get support, share feedback, and meet the Marvi community.',
  'home.banners.discordTitle': 'Marvi Community',
  ...
  'intelligence.diagram.imageAlt': 'Latest generated Marvi architecture diagram',
  ...
  'rewards.community.heroTitle': 'Earn rewards with Marvi',
  ...
  'settings.ai.openhumanDefault': 'Marvi (default)',
  ...
  'settings.ai.routing.managedDesc':
    'Marvi will run all inference in the cloud, choose the best model for the task, optimize for cost, and keep the safest routing defaults.',
  'settings.ai.routing.managedMsg':
    'Marvi will handle all inference for every workload and automatically choose the best route for cost, quality, and security.',
  ...
  'settings.composio.confirmWarning':
    "Your existing integrations (Gmail, Slack, GitHub, etc. linked through Marvi) won't be visible — they live in the Marvi-managed Composio tenant.",
  ...
  'settings.composio.modeManaged': 'Managed (Marvi handles it for you)',
  'settings.composio.modeManagedDesc':
    'Marvi proxies tool calls through our backend (recommended). Auth is brokered; you never paste a Composio API key. Webhooks are fully routed.',
  ...
  'settings.localModel.status.ollamaNotInstalledDesc':
    'Marvi now treats Ollama as an external inference runtime. Start your own Ollama server, pull the models you want, and point workload routing at it.',
  ...
  'settings.developerMenu.tools.desc':
    'Enable or disable capabilities Marvi can use on your behalf',
  ...
  'settings.developerMenu.mcpServer.desc': 'Configure external MCP clients to connect to Marvi',
  ...
  'settings.mascot.characterDesc': 'Choose your Marvi character.',
  ...
  'settings.mascot.colorAria': 'Marvi color',
  ...
  'settings.memoryWindow.description':
    'How much remembered context Marvi injects into every new agent run. Larger windows feel more aware of past conversations but use more tokens — and cost more — on every run.',
  ...
  'skills.meetingBots.bannerDesc':
    'Marvi joins calls silently and handles notes and follow-ups automatically.',
  'skills.meetingBots.bannerTitle': 'Send Marvi to your next meeting',
  'skills.meetingBots.busyTitle': 'Marvi is busy',
  'skills.meetingBots.comingSoon': 'coming soon',
  'skills.meetingBots.couldNotStartTitle': 'Could not start Marvi',
  'skills.meetingBots.displayName': 'Display name',
  'skills.meetingBots.failedToStart': 'Failed to start Marvi.',
  'skills.meetingBots.joiningMessage': 'It should appear as a participant in a few seconds.',
  'skills.meetingBots.joiningTitle': 'Marvi is joining the meeting',
  'skills.meetingBots.meetingLink': 'Meeting link',
  'skills.meetingBots.modalAriaLabel': 'Send Marvi to a meeting',
  'skills.meetingBots.modalDesc':
    'Marvi will join as a silent participant and help with notes and follow-ups.',
  'skills.meetingBots.modalTitle': 'Send Marvi to a meeting',
  ...
  'settings.mascot.noCharactersAvailable': 'No Marvi characters are available yet',
  ...
  'settings.localModel.status.manageOllamaExternal':
    'Manage the Ollama process and model pulls outside Marvi, then rerun diagnostics.',
  ...
  'devOptions.menuToolsDesc': 'Enable or disable capabilities Marvi can use on your behalf',
  ...
  'keyring.consent.description':
    'Your operating system keychain is not accessible. Marvi needs your permission to store secrets using local encrypted storage instead.',
